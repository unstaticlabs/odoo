...
5. Open or update the ready PR with `scripts/agent/github pr --handoff PATH`. GitHub is the canonical engineering handoff; the generated artifact remains ignored local state.
