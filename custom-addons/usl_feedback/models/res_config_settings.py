...
class ResConfigSettings(models.TransientModel):
    ...
    def action_clear_feedback_mcp_key(self):
        ...
        return self._feedback_notification(
            ...
            _("Existing feedback lookup is off. The assistant still works with Gemini."),
            "warning",
        )
    ...
    def action_test_feedback_agent(self):
        ...
        detail = (
            _("Gemini and existing feedback lookup are ready.")
            if mcp_enabled
            else _("Gemini is ready. Existing feedback lookup is off until Projects MCP is configured.")
        )
