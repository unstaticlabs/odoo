...
The restored perimeter contains 1,834 tasks: 1,783 active and 51 archived. It
also contains one task template. Finalized `odoo_dev` has 11 additional native
tasks: four Odoo welcome tasks and seven next occurrences generated by the
restored recurrence rules. An unfiltered count of 1,845 is therefore expected,
...
Six tasks have a restored Planned Start. On a task with dependencies, compare
...
The copy contains 1,234 parent/subtask links and 227 dependency links.
...
There are 3 milestones, 15 recurrence configurations and 16 project updates.
...
The restoration contains 19,127 messages, 7,720 tracked changes, 700
activities, 2,109 followers and 38 attachments. The attachments total
...
Two projects have analytic accounts and those accounts connect to 117 restored
