...
- [Email a document](how-to/email-a-document.md)
...
- [Record and reconcile external-provider payroll](guides/paie-tese.md)
- [Review B2C commerce history](guides/review-b2c-commerce.md)
- [Process content-platform payouts](how-to/process-platform-payouts.md)
- [Traiter les encaissements plateformes](how-to/traiter-encaissements-plateformes.md)
- [Create and collect a customer invoice](how-to/process-customer-invoice.md)
- [Generate official documents](guides/official-documents.md)
...
- [Analyze analytic performance](how-to/analyze-analytic-performance.md)
- [Prepare electronic-invoice reception](how-to/prepare-electronic-invoice-reception.md)
...
- [Send product feedback](how-to/send-product-feedback.md)
