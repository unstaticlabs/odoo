...
| Shared conversational product feedback with a private local Odoo-page preview, default-selected sanitized page details, Gemini or network-free local clarification, reporter withdrawal and human-confirmed Triage | `usl_feedback` over native Project, mail and Settings models | Persistent **Feedback** action beside **New Message**; floating native Thread/Composer with live follow-up replies and compact **Feedback #…** / **My feedback** / **New** navigation; shared **Board**; **Product Feedback** for maintainers | [Product contract](product-feedback.md), [user how-to](../users/how-to/send-product-feedback.md), [access-risk inventory](../agents/distribution-access-risk-inventory.md) | **Feature candidate**; human approval is required after Feature/Worktree-QA review before Lead handoff |
...
| `usl_feedback` | Shared conversational product feedback, screen evidence, Gemini or deterministic local shaping and confirmed native Project workflow | Delivered product feature on the human-gated integration candidate |
