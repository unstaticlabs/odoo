...
| Shared conversational product feedback with a private local Odoo-page preview, default-selected sanitized page details, Gemini-assisted clarification, reporter withdrawal and human-confirmed Triage | `usl_feedback` over native Project, mail and Settings models | Persistent **Feedback** action beside **New Message**; floating native Thread/Composer with the active **Feedback #…** conversation, **My feedback** status tracking and **New**; shared **Board**; **Product Feedback** for maintainers | [Product contract](product-feedback.md), [user how-to](../users/how-to/send-product-feedback.md), [access-risk inventory](../agents/distribution-access-risk-inventory.md) | **Feature candidate**; human approval is required after Feature/Worktree-QA review before Lead handoff |
