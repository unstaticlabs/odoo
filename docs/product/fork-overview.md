...
Paperless 3.0, Native Sign and Collaboration History remain unmerged release
workstreams. Distribution Access Control is qualified on a dedicated
integration candidate but does not become `19-usl` production authority until
its merge-commit PR lands. Feature worktrees and archives are never production
authority.
