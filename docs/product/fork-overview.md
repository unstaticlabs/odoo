...
| Shared conversational product feedback with default screen capture, opt-in sanitized page context, Gemini-assisted clarification and human-confirmed Triage | `usl_feedback` over native Project, mail and Settings models | Top-right messages drawer **Chats > Feedback**; shared **Board**; **Product Feedback** for maintainers | [Product contract](product-feedback.md), [user how-to](../users/how-to/send-product-feedback.md), [access-risk inventory](../agents/distribution-access-risk-inventory.md) | **Feature candidate**; human approval is required after Feature/Worktree-QA review before Lead handoff |
