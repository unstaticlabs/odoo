...
The Accounting app must open directly to an accounting dashboard or workbench.
...
The current Community top-level app label "Invoicing" is not sufficient for Milestone 13. Users need a clear Accounting entry point that opens the accounting dashboard directly.
...
The Accounting dashboard should show upcoming and open declaration work.
...
- [ ] A user can open Accounting from the app launcher without knowing `/odoo/accounting`.
- [ ] A user can reach the main daily workflows in two clicks.
...
- [ ] Report lines drill down to journal items and evidence.
- [ ] Declaration guidance shows official form/box mappings and sources.
- [ ] Declaration reminders are visible on the accounting dashboard.
- [ ] FEC can be generated by the intended authorized user.
