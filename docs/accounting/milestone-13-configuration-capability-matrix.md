...
| Fiscal Years | Company-configured fiscal-year end and explicit first fiscal-year boundaries drive report, declaration and closing periods. | Implemented | Report/PDF and closing/declaration tests prove the exceptional `10/01/2024`–`30/09/2025` first exercise before the recurring 1 October–30 September cadence. |
