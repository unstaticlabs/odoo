...
- full-period bank/general-reconciliation coverage, including the `114` non-bank document edges, outside-perimeter aggregate allocations, write-offs and undo; expense and direct commercial-document bank matching now pass
